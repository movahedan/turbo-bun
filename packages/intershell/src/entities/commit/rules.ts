...
import type { CommitConfig, CommitRule, StagedConfig } from "./types";
...
const defaultStagedConfig: StagedConfig = [
	{
	...
	},
	{
		...
		description: "CHANGELOG.md should be auto-generated by 'bun run version:apply'",
	},
	{
		...
		ignore: { mode: "create" },
		disabled: process.env.CI === "true",
		description: "package.json version should be auto-generated by 'bun run version:apply'",
	},
];
...
class CommitRules {
	...
	private stagedConfig: StagedConfig;

	constructor(
		config: CommitConfig = defaultConfig,
		stagedConfig: StagedConfig = defaultStagedConfig,
	) {
		this.config = this.mergeConfig(config);
		this.stagedConfig = stagedConfig;
